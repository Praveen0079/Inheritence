...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        Manager manager = new Manager("Anish", 1011, 80000, 10);
        Developer developer = new Developer("Anshika", 1002, 60000, "Java");
        Intern intern = new Intern("Shubham", 1036, 20000, "Xyzx University");
